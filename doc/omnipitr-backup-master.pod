...
Directory that (if doesn't exist) will be created. Then - will be used as source
of xlogs to archive. Afterwards - it will be removed (if it didn't exist in the
beginning).
