...
You can get the OmniPITR project from L<https://github.com/omniti-labs/omnipitr>. Within this directory you will find set of directories:
...
=item 4. Uncompress backup using normal tar commands.

=item 5. Start PostgreSQL recovery from hot-backup: I<omnipitr-restore>

=back

Alternativaly steps 2-4 can be replaced by usage of I<omnipitr-synch> tool.
