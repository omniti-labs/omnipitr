...
In any way, we need to make some extra directories:
...
internal stuff, not really interesting, small files only, but required it we
have more than 1 destination
