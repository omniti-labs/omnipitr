...
Simply fetch the directory L<https://labs.omniti.com/pgsoltools/trunk/omnipitr>, and you're done. More details are in I<doc/install.pod>.
...
This should be used on master server, as I<archive_command> command.

=item * omnipitr-restore

This should be used on slave server/servers, as I<restore_command> command.
